...
namespace AttendanceAPI.Controllers
{
    ...
    public class LeaveController : ControllerBase
    {
        ...
        public LeaveController(ApplicationDbContext db, ICurrentUserService currentUserService, ILogger<LeaveController> logger, ITeamManagementHelper teamHelper)
        {
            _db = db;
        ...
        public async Task<IActionResult> GetPendingApprovals()
        {
            try
            {
                ...
                {
                    var teamUserIds = await _teamHelper.GetManagerTeamUserIdsAsync(userId.Value);
                    if (teamUserIds == null)
