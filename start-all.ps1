...
# Kill any existing processes on required ports (monolithic backend ports)
...
Write-Host "  Vermillion.API: http://localhost:5000" -ForegroundColor Magenta
Write-Host ""
Write-Host "Frontend Apps:" -ForegroundColor White
Write-Host "  Web App:        http://localhost:4200" -ForegroundColor Green
Write-Host "  Mobile App:     http://localhost:4300" -ForegroundColor Yellow
Write-Host ""
